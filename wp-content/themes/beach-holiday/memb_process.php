					...
					<form class="memb_reg_form" id="memb_proc_form" name="memb_proc_form" method="post"
						...
						<fieldset class="reg_form" id="memb_type">
							...
							<div class="reg_renewal_row" id="memb_type">
								...
								<label for="memb_type_1">Individual - $<?php echo $memb_costs[ 1 ]->cost; ?></label>
								...
								<label for="memb_type_3">Couple - $<?php echo $memb_costs[ 3 ]->cost; ?></label>
								<input class="memb_type" id="memb_type_4" type="radio" name="memb_type" value="4"
								       <?php if ($memb_type_id === 4) { ?>checked<?php }; ?>>
								<label for="memb_type_4">Household - $<?php echo $memb_costs[ 4 ]->cost; ?></label>
							</div>
						</fieldset>
						...
						<fieldset class="reg_form" id="spouse_info">
							...
							<div class="reg_renewal_row">
								...
								<input class="memb_proc_field validate[custom[onlyLetterSp]]" data-prompt-position="bottomLeft"
						...
						<fieldset class="reg_form" id="family_info">
							...
							<section><!--  Begin 1st Child/Other Info fieldset -->
								...
								<div class="reg_renewal_row">
									...
									<input class="reg_last_name validate[condRequired[c1_first_name], custom[onlyLetterSp]]" data-prompt-position="bottomLeft"
								...
								<div class="reg_renewal_row">
									...
									<input class="cm_birthday validate[condRequired[c1_first_name], custom[onlyNumber]]" data-prompt-position="bottomLeft"
							...
							<section><!-- Begin 2nd FAMILY MEMBER -->
								...
								<div class="reg_renewal_row">
									...
									<input class="reg_last_name validate[condRequired[c2_first_name], custom[onlyLetterSp]]" data-prompt-position="bottomLeft"
								...
								<div class="reg_renewal_row">
									...
									<input class="cm_birthday validate[condRequired[c2_first_name], custom[onlyNumber]]" data-prompt-position="bottomLeft"
							...
							<section><!-- 3rd FAMILY MEMBER -->
								...
								<div class="reg_renewal_row">
									...
									<input class="reg_last_name validate[condRequired[c3_first_name], custom[onlyLetterSp]]" data-prompt-position="bottomLeft"
...
<img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
 ...
 -->
									...
									?>
									<form action="https://www.<?php echo($sandbox)?>paypal.com/cgi-bin/webscr" method="post"
									      target="_top">
										<input type="hidden" name="cmd" value="_s-xclick">
										...
										<table>
											<tr>
												<td>
													<input type="hidden" name="on0" value="Registration Type">Registration
													Type
												</td>
											</tr>
											<tr>
										...
										<input type="hidden" name="return" value="<?php echo bloginfo( 'url' ),$target_return; ?>">
										<input type="hidden" name="currency_code" value="USD">
										<input type="image"
										       src="https://www.<?php echo($sandbox)?>paypal.com/en_US/i/btn/btn_paynowCC_LG.gif"
										       name="submit"
										       alt="PayPal - The safer, easier way to pay online!">
										<img alt="" src="https://www.<?php echo($sandbox)?>paypal.com/en_US/i/scr/pixel.gif"
										     width="1"
										     height="1">
									</form>
									</div>
